...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "VapeX " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"VapeXtools.com", "dnsseed.VapeXtools.com"},
    {"VapeXpool.org", "dnsseed.VapeXpool.org"},
    {"xurious.com", "dnsseed.VPX.xurious.com"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"VapeXtools.com", "testnet-seed.VapeXtools.com"},
    {"xurious.com", "testnet-seed.VPX.xurious.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. VapeX is probably already running."), addrBind.ToString().c_str());
        else
